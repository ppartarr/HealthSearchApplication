"""
Django settings for health_search project.
...
SECRET_KEY = 'o0s!81zm5ax%c8rx__l=j(n$5ea8($5o$2w!put9lysr$ixzc8'
...
ROOT_URLCONF = 'health_search.urls'

WSGI_APPLICATION = 'health_search.wsgi.application'
